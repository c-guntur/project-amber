...
//----------------------------------------------------------------------------------------------
// CAN HAVE MULTIPLE CONSTRUCTORS, BUT NON-FULL CONSTRUCTORS CAN ONLY CALL THE FULL CONSTRUCTOR
...
sealed interface MyShape
        permits MyTriangle, MyRectangle {

    String getDescription();
}

final record MyTriangle(int side1Length, int side2Length, int side3Length) implements MyShape {
...
final record MyRectangle(int width, int height) implements MyShape {
...
public class Ex6Records {
    ...
    public static void main(String[] args) {
        ...
        //  🔹 IMPLICITLY FINAL
        //  🔹 CANNOT BE ABSTRACT
        //  🔹 IMMUTABLE, THUS NO MUTATORS (SETTERS)
        //  🔹 ACCESSORS ARE IMPLICIT AND SHARE THE NAME OF THE ATTRIBUTE
        ...
        System.out.println("11. Using a sealed record --->\n\t\t" +
                triangle+"\n");
        MyRectangle rectangle = new MyRectangle(4, 9);
